        ...
        <div class="relative flex h-16 items-center justify-between">
            <div class="flex flex-2 items-center justify-center sm:items-stretch sm:justify-start">
                <div class="flex flex-shrink-0 items-center">
                    <img class="h-8 w-auto" src="public/images/Team_fainort_logo.png" alt="logo_team_fainort">
                </div>
                <div class="hidden sm:ml-4 sm:block">
                    <div class="flex space-x-4">
                        ...
                        <a href="{{route('team')}}" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Team</a>
                    </div>
                </div>
            </div>
