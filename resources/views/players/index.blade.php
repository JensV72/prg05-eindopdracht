    ...
    <div class="container mx-auto py-8 px-4">
        <section class="w-full flex flex-col items-center mb-8">
            <div class="flex w-full max-w-lg">
                <x-dropdown width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center h-10 px-4 text-sm bg-gray-800 font-medium text-gray-300 hover:bg-gray-700 hover:text-white focus:outline-none transition ease-in-out duration-150 rounded-l-md">
                            <div class="whitespace-nowrap">Filter by Position</div>
                            <div class="ml-1">
